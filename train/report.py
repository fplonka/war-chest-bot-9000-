...
def page(runs, title, js):
    ...
    body.append("<footer>Generated by train/report.py. The truth column measures "
                "distance to the network that built the frozen set, and was shown "
                "to rank that network's neighbourhood above stronger ones "
                "(train/truth.py) &mdash; read it within one run, never across arms. "
                "Elo error bars are per-player "
