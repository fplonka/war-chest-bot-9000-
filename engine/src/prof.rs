...
mod imp {
    ...
    counters!(
        BUILD, BACTS, BDRAW, DGEN, DSORT, DCOMP, BAPPLY, BPUSH, ALLOC, SERIAL, REACH, PUBFEAT,
        PUBNET, BELFEAT, NET, LEAFDOT, LEAFPOST, BACK, RM, AVG, WALK, SNAP, P2, ADVANCE, TRIP1,
        TRIP2, DLIDLE, DLSYNC, DLBUSY, SVCTICK, SVCHDR, SVCADMIT, SVCFENCE,
    );
