...
final checkpoint; a ladder against `snap_00.pt`, Greedy, and Random is still
needed to verify that this particular run improved playing strength before a
longer 5+25-minute run.
