...
dropped work. Average GPU use was 65.6% and 64.4%; peak memory was 9,781 and
7,559 MiB.
...
steady-state target. Memory remained far below 24 GiB, so five lanes became the
production choice for the next real warm-training gate.
