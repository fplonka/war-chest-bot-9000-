...
and no dropped work. Average GPU use was 65.7% and 64.5%; peak memory was only
9,485 and 9,919 MiB.
...
better than expected because the new half-precision head also reduced the
largest dynamic scratch regions. At this point four lanes were safe for a real
training gate, with enough headroom to test one more lane cheaply first.
